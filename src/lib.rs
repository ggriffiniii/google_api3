pub use google_api3_derive::FieldSelector;
...
/// subfields to include in a response.
/// This will typically be automatically generated from a procedural macro using
...
impl<T> FieldSelector for Leaf<T> {
    fn field_selector_with_ident(ident: &str, selector: &mut String) {
        append_ident_to_selector(ident, selector);
    }
}
